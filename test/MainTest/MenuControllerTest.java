 ...
 * @author Jayden Tosul
 */
public class MenuControllerTest implements ActionListener {
    ...
    //constructor
    public MenuControllerTest(MenuPanel mp) {
        this.mp  = mp;
...
//            case "QUICK"    -> quickPlay();
    ...
    private void scoreBoard() {
        ...
        try {
            ...
            //calls the sortList to sort them based on the playerScore
            sortScore(playerList);
    ...
    //sorts the list based on their score
    private Player[] sortScore(Player[] list) {
